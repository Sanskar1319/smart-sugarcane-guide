import { R as React, u as useNavigate, b as useQueryClient, r as reactExports, j as jsxRuntimeExports, c as ue } from "./index-BJHXwJTK.js";
import { u as useActor, a as useMutation, A as AnimatePresence, c as createActor } from "./backend-DidiFDXl.js";
...
async function apiSavePrediction(actor, input) {
  return actor.savePrediction(input);
}
const SOIL_TYPES = ["Loam", "Clay", "Sandy", "Black Soil"];
const SOIL_KEYS = {
...
function PredictPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Layout,
    {
      showHeader: true,
      headerTitle: "",
      headerLeft: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-sm font-medium", children: t("common.back") })
          ]
        }
      ),
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pb-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-xl font-extrabold text-foreground leading-tight", children: t("predict.title") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-0.5 font-body text-sm text-muted-foreground", children: t("predict.subtitle") })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-6 flex gap-3", "aria-label": `Step ${step} of 2`, children: [1, 2].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 flex-col gap-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: `h-1.5 rounded-full transition-colors duration-300 ${s <= step ? "bg-primary" : "bg-muted"}`
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              className: `font-body text-xs ${s === step ? "font-semibold text-foreground" : "text-muted-foreground"}`,
              children: s === 1 ? t("predict.step1") : t("predict.step2")
            }
          )
        ] }, s)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("form", { onSubmit: handleSubmit(onSubmit), children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: step === 1 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-elevated p-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3 flex items-center justify-between", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "label",
                    {
                      ...
                      children: t("predict.temperature")
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "rounded-md bg-foreground px-2.5 py-1 font-body text-sm font-bold text-card", children: [
                    temp,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-1 flex justify-between", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-xs text-muted-foreground", children: "15°C" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-xs text-muted-foreground", children: "40°C" })
                ] }),
                errors.temperature && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-elevated p-4", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-1 flex justify-between", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-xs text-muted-foreground", children: "30%" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-xs text-muted-foreground", children: "90%" })
                ] }),
                errors.humidity && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    "data-ocid": "predict.humidity_field_error",
                    className: "mt-1 font-body text-xs text-destructive",
                    children: errors.humidity.message
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-elevated p-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "label",
                  {
                    ...
                    children: t("predict.rainfall")
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mb-2 font-body text-xs text-muted-foreground", children: t("predict.rainfallHint") }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rounded-md bg-muted px-3 py-3 font-body text-sm font-semibold text-muted-foreground", children: t("predict.rainfallUnit") })
                ] }),
                errors.rainfall && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    "data-ocid": "predict.rainfall_field_error",
                    className: "mt-1 font-body text-xs text-destructive",
                    children: errors.rainfall.message
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-elevated p-4", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "select",
                    {
                      ...
                      children: SOIL_TYPES.map((soil) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: soil, children: t(SOIL_KEYS[soil]) }, soil))
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                ...
                errors.soilType && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    "data-ocid": "predict.soil_type_field_error",
                    className: "mt-1 font-body text-xs text-destructive",
                    children: errors.soilType.message
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              mutation.isPending && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "p",
                {
              ...
              mutation.isError && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  role: "alert",
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-destructive", children: t("result.saveError") })
                }
              )
            ]
          },
